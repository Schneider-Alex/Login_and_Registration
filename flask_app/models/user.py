...
class User:
    ...
    def validate_account( form ):
        ...
        results = connectToMySQL('loginpassword_schema').query_db(query, form)
        if len(results) >= 1:
    ...
    def get_all(cls):
        ...
        results = connectToMySQL('loginpassword_schema').query_db(query)
    ...
    def get_one(cls, data):
        ...
        results = connectToMySQL('loginpassword_schema').query_db(query,data)
    ...
    def save(cls, dict):
        ...
        return connectToMySQL('loginpassword_schema').query_db( query, data )
